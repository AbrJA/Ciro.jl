...
@testset "Core" begin
    ...
    @testset "Response serialization" begin
        ...
        resp = text("Hello")
        n = Ciro.serialize_response!(buf, resp)
        ...
        n = Ciro.serialize_response!(small_buf, resp)
        @test n > 100_000
    ...
    @testset "Custom logger integration" begin
        ...
        Ciro.log_event(::TestLogger, level::LogLevel, msg::String) = push!(messages, msg)
    ...
    @testset "Dispatch logic" begin
        ...
        resp = Ciro._dispatch(server, req)
        ...
        resp2 = Ciro._dispatch(server, req2)
        ...
        resp3 = Ciro._dispatch(server, req3)
        ...
        resp4 = Ciro._dispatch(server, req4)
